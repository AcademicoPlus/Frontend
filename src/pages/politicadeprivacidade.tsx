  ...
  return (
    <div className="min-h-screen w-full bg-[#F8F9FA] dark:bg-slate-950 font-sans py-10 px-6">
      <div className="max-w-2xl mx-auto bg-white dark:bg-slate-900 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 dark:border-slate-700 p-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4 mb-1">Política de Privacidade — Academico+</h1>
        ...
        <div className="flex flex-col gap-5 text-gray-700 dark:text-gray-200 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">1. Quais dados coletamos</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-slate-700">
                    <th className="py-2 pr-4 font-semibold text-gray-900 dark:text-gray-100">Dado</th>
                    <th className="py-2 font-semibold text-gray-900 dark:text-gray-100">Finalidade</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">2. Base legal para o tratamento</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Com quem compartilhamos dados</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Seus direitos como titular dos dados (LGPD)</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">5. Retenção de dados</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">6. Segurança</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">7. Contato</h2>
            <p>
